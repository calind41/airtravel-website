    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div
          ...
          // style={middleWidth && outerWidth > 1372 ? { width: middleWidth } : {}}
          className={`${styles.middle} ${styles[middleClassName]}`}
        >
