    ...
    <div className={styles.toInput}>
      <label>
        <input
          ...
          // onBlur={() => {
          //   if (toValue === "") setToValue(" ");
          // }}
          onChange={filterLocations}
        />
        <span id='toInputAcronymId'>{acronym}</span>
        {/* <span className={styles.toInputPlaceholder}>Прибытие</span> */}
        {/* <span className={styles.toInputPlaceholder}>Aterizare în</span> */}
        <span className={styles.toInputPlaceholder}>
          {t("Arrival-toInputPlaceholder")}
        </span>
      </label>
