export const planeIcon = (
  <svg
    ...
    viewBox='0 0 24 24'
  >
    <g id='Group_225' data-name='Group 225' transform='translate(-87 -336)'>
      <rect
        id='Rectangle_340'
        data-name='Rectangle 340'
        width='24'
        height='24'
        transform='translate(87 336)'
        fill='none'
      />
      <g id='icons8-airport' transform='translate(87 336)'>
        <path
          id='Path_259'
          data-name='Path 259'
          d='M10,4h4V21H10Z'
        ...
        <path
          id='Path_260'
          data-name='Path 260'
          d='M11,8.378,2,14v2l9-2.805Zm2,0L22,14v2l-9-2.805Zm-1,9.13L8,20.5V22l4-1Zm0,0L16,20.5V22l-4-1ZM12,2a2,2,0,1,0,2,2A2,2,0,0,0,12,2Z'
          fill='#7a7d80'
        />
      </g>
    </g>
...
export const locationIcon = (
  <svg
    ...
    fill='#7A7D80'
  >
    <g id='Group_227' data-name='Group 227' transform='translate(-45 -444)'>
      <rect
        id='Rectangle_341'
      ...
      <path
        id='icons8-marker'
        d='M12,2A7,7,0,0,0,5,9c0,5,7,13,7,13s7-8,7-13A7,7,0,0,0,12,2Zm0,9.5A2.5,2.5,0,1,1,14.5,9,2.5,2.5,0,0,1,12,11.5Z'
        transform='translate(45 444)'
        fill='#7a7d80'
      />
    </g>
  ...
  >
    ...
    >
      <path
        id='Path_255'
        data-name='Path 255'
        d='M-137.428,19.47l-13.231,8.7,2.117,3.837h.794s56.223-18.453,64.3-20.723,20.073-7.1,21.434-6.908S-49.84,4.12-49.84,4.12L-35.55-3.555l-1.852-6.4s23.592-14.074,27.52-16.373,14.22-7.5,15.348-11.768c1.062-2.914-2.406-4.018-3.969-4.349s-9.709-1.847-21.963,1.279-24.609,11-24.609,11S-95.041-3.656-100.911-1.253c-8.142,2.424-13.6,4.32-32.283-2.558s-23.286-8.7-23.286-8.7l-9.526,5.117Z'
        transform='translate(1294.173 238.548)'
        fill='#dce1e8'
        fillRule='evenodd'
      />
...
export const closeIconSvg = (
  <svg
    ...
    viewBox='0 0 17 17'
  >
    <g id='Symbol' transform='translate(-312.533 -2929.54)'>
      <path
        id='Symbol-2'
        data-name='Symbol'
        d='M.033,2.54a8.558,8.558,0,0,0,8.5-8.5,8.57,8.57,0,0,0-8.508-8.5,8.561,8.561,0,0,0-8.492,8.5A8.563,8.563,0,0,0,.033,2.54Zm-2.992-4.8a.706.706,0,0,1-.7-.708.648.648,0,0,1,.208-.483l2.492-2.5-2.492-2.5a.635.635,0,0,1-.208-.483.7.7,0,0,1,.7-.692.635.635,0,0,1,.483.208l2.5,2.492,2.517-2.5a.636.636,0,0,1,.483-.217.7.7,0,0,1,.7.7.6.6,0,0,1-.208.483l-2.5,2.508L3.508-3.468a.685.685,0,0,1,.208.5.7.7,0,0,1-.7.708.7.7,0,0,1-.5-.208L.025-4.968l-2.483,2.5A.672.672,0,0,1-2.958-2.26Z'
        transform='translate(321 2944)'
        fill='#b6babf'
      />
    </g>
  </svg>
...
export const goBackMobileSvg = (
  <svg
    ...
    viewBox='0 0 44 44'
  >
    <g id='ic_goback_mobile' transform='translate(467 -1295) rotate(90)'>
      <rect
        id='Rectangle_190'
      ...
      <path
        ...
        transform='translate(923 -1862.935)'
        fill='none'
        stroke='#787b82'
...
export const arrowNextSvg = (
  <svg
    ...
    viewBox='0 0 24 24'
  >
    <g id='ic_arrownext' transform='translate(-332 -688)'>
      <rect
        id='Rectangle_344'
        data-name='Rectangle 344'
        width='24'
        height='24'
        transform='translate(332 688)'
        fill='none'
      />
      <g id='icons8-right_arrow' transform='translate(332 688)'>
        <path
          id='Path_261'
          data-name='Path 261'
          d='M19,16V8l4,4Z'
