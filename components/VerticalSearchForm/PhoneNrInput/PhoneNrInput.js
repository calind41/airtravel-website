...
import styles from "./PhoneNrInput.module.scss";
    ...
    <div className={styles.phoneNrC}>
      <label htmlFor='phoneNr'>
        ...
        <input
          ...
          required
        />
        <span className={styles.phoneNrPlaceholder}>Номер телефона</span>
      </label>
      <span className={styles.requiredField}>Поле обязательное</span>
      <span className={styles.numberNotValid}>Неверный номер</span>
    </div>
  );
}
