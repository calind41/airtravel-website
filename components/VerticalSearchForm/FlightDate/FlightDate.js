...
export default function FlightDate({ passCalendarState, widthClass }) {
  const [departingValue, setDepartingValue] = useState("DATA");
  ...
  return (
    <>
      <div
        ...
        id='departingCid'
      >
        <span className={styles.calendarPlaceholder}>КОГДА</span>
        <span
