...
const getLanguageSpecificContent = (key) => {
  return i18n.t(`flyToCity:${key}`);
};

export default function FlyToCityComponent_M() {
    ...
    <section className={styles.howToSaveOnFlightContainer}>
      <div className={styles.ticketPrice}>
        <div className={styles.title}>
          ...
          {getLanguageSpecificContent("HowToSaveOnFlight-title2")}
          Рим
        </div>
...
function WeatherFullYearComparison() {
  const monthNames = [
    "JAN",
    "FEB",
    "MAR",
