...
export default function Departure({ t }) {
  ...
  return (
    <div className={styles.fromInput}>
      <label>
        ...
        <span className={styles.fromInputPlaceholder}>
          {t("Departure-fromInputPlaceholder")}
        </span>
      </label>
      ...
      {isRenderedLocationsSmall ? <LocationsSmallScreen t={t} /> : null}
    </div>
  );
}
